"""Module containing the CustomMistralV3TekkenPromptTokenizingStrategy class"""
...
class CustomMistralV3TekkenPromptTokenizingStrategy(PromptTokenizingStrategy):
    """
    Tokenizing strategy for CustomMistralV3Tekken.
    """
...
class CustomMistralV3TekkenPrompter:
    """
    Prompter for CustomMistralV3Tekken.
    """
...
# Function to load the CustomMistralV3TekkenPromptTokenizingStrategy
def load(tokenizer, cfg):
    return CustomMistralV3TekkenPromptTokenizingStrategy(
        CustomMistralV3TekkenPrompter(),  # TODO: Remove this as it doesn't get used
        tokenizer,
        cfg.train_on_inputs,
        cfg.sequence_len
    )
